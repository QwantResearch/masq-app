...
const Modal = ({ title, mobileHeader, onClose, width, padding, children }) => {
...
const ResponsiveModal = ({ title, mobileHeader, onClose, width, children, padding }) => {
  const isMobile = useMediaQuery({ maxWidth: styles.mobileWidth })
  console.log('isMobile', isMobile, styles.mobileWidth)
  ...
  return (
    <div>
      {isMobile
        ? <Modal title={title} mobileHeader={mobileHeader} width='100%' onClose={onClose} children={children} />
